...
begin
  ...
  insert into public.schedule_revision_task_snapshots(
    ...
    remaining_duration_days, constraint_type, constraint_date
  )
  select v_revision.id, t.id, t.name, t.parent_task_id, t.start_date, t.finish_date,
    ...
    t.actual_start_date, t.actual_finish_date, t.forecast_start_date, t.forecast_finish_date,
    t.remaining_duration_days, t.constraint_type, t.constraint_date
