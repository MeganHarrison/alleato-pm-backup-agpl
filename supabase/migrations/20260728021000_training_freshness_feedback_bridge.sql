-- Bridge freshness decisions into the canonical resource review memory consumed
-- by future discovery. The sidecar retains immutable decision evidence, while
-- training_resource carries the latest admin-approved good/bad example.
