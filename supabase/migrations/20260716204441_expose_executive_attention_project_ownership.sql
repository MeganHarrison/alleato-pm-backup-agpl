-- AAI-1106: retain the durable project ownership already present on attention
-- records in the controlled service-only read DTO. Consumers must not guess
-- ownership from packet evidence when a direct project relation exists.
