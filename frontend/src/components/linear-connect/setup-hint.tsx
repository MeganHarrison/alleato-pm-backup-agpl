...
export function SetupHint({
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-2xl flex-col items-center justify-center px-6 py-16">
      <div className="w-full rounded-2xl border border-neutral-800 bg-neutral-900/60 p-8 shadow-sm">
        <h1 className="text-xl font-semibold text-status-warning">{title}</h1>
