...
type PopoverLayer = "default" | "global-ai-widget";

const PopoverLayerContext = React.createContext<PopoverLayer>("default");

function PopoverLayerProvider({
  layer,
  children,
}: {
  layer: PopoverLayer;
...
function PopoverContent({
  ...
  const layer = React.useContext(PopoverLayerContext);
  return (
