...
| Ledger command             | `npm run db:migrations:verify-applied -- supabase/migrations/20260731231000_secure_notes_rls.sql`                                                                                                                                  | Deferred                          | Run only after approved production apply.                                                                                                                                                                                                                                               |
