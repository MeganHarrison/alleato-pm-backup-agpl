...
`.Codex/rules/DETAIL-PAGE-GATE.md`, `DESIGN-SYSTEM-GATE.md`, `PAGE-LAYOUT-GATE.md`,
...
> in the same turn (that is a hard rule from AGENTS.md), then encode it here as a new rubric item.
