...
Write to `.Codex/artifacts/<run-name>-integration-summary.md`. Create the `.Codex/artifacts/` directory if it doesn't exist.
...
```
Wrote .Codex/artifacts/<run-name>-integration-summary.md
