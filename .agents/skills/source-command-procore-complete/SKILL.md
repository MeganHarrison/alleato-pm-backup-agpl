---
name: "source-command-procore-complete"
...
# source-command-procore-complete

Use this skill when the user asks to run the migrated source command `procore-complete`.
