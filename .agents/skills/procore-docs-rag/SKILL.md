...
```
.Codex/procore-manifests/{tool-slug}/
...
Read .Codex/procore-manifests/{tool-slug}/manifest.json

# Read raw DOM for a specific state (list, create-form, detail)
Read .Codex/procore-manifests/{tool-slug}/dom/list.html
```
...
The recrawl opens a real browser, logs into Procore, navigates to the tool, and captures the fully-rendered DOM. It overwrites the manifest and dom/ files in `.Codex/procore-manifests/{tool-slug}/`.
...
Read .Codex/procore-manifests/change-orders/manifest.json
```
...
Read .Codex/procore-manifests/commitments/manifest.json
# If manifest fields look incomplete, read the raw DOM
Read .Codex/procore-manifests/commitments/dom/create-form.html
```
...
Read .Codex/procore-manifests/invoicing/manifest.json
Read .Codex/procore-manifests/invoicing/dom/create-form.html   # if field detail needed
...
| Manifest base path | `.Codex/procore-manifests/` |
