---
name: "source-command-github-commands-ci-commit"
description: "Create git commits for session changes with clear, atomic messages"
---

# source-command-github-commands-ci-commit

Use this skill when the user asks to run the migrated source command `github-commands-ci_commit`.
