...
| What Codex usually checks | What actually matters |
|---|---|
...
>
> `.Codex/hooks/verify-feature-gate.py` enforces three gates with exit code 2:
>
...
3. Check `.Codex/procore-manifests/{tool-slug}/manifest.json` if it exists
...
> ⚠️ **This is Gate 11 from AGENTS.md.** Must be tested for every feature with select/dropdown fields.
