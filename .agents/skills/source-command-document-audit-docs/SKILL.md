---
name: "source-command-document-audit-docs"
description: "Verify documentation files for accuracy and completeness"
---

# source-command-document-audit-docs

Use this skill when the user asks to run the migrated source command `document-audit-docs`.
