---
name: "source-command-procore-gap-audit"
...
# source-command-procore-gap-audit

Use this skill when the user asks to run the migrated source command `procore-gap-audit`.
