---
name: "source-command-workflow-create-handoff"
description: "Create handoff document for transferring work to another session"
---

# source-command-workflow-create-handoff

Use this skill when the user asks to run the migrated source command `workflow-create_handoff`.
