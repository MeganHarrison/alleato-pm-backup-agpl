---
name: "source-command-github-commands-commit"
description: "Create git commits with user approval and no Codex attribution"
---

# source-command-github-commands-commit

Use this skill when the user asks to run the migrated source command `github-commands-commit`.
