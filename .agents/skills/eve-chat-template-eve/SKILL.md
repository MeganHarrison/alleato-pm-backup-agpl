...
- Consider a turn settled on the completed, failed, or waiting session events. Treat a required connection-authorization event as a blocked state for normal text input.
