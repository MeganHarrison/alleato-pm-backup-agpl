...
> Definition: `.Codex/skills/testing/test-scenario-audit/SKILL.md`.
...
3. `.Codex/procore-manifests/<tool-slug>/manifest.json` (if present — skip if missing)
...
| Procore manifests | `.Codex/procore-manifests/<tool>/` |
| PRPs | `docs/PRPs/<tool>/` |
