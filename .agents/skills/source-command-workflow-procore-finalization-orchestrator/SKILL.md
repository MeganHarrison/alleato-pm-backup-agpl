---
name: "source-command-workflow-procore-finalization-orchestrator"
...
# source-command-workflow-procore-finalization-orchestrator

Use this skill when the user asks to run the migrated source command `workflow-procore-finalization-orchestrator`.
...
- Read existing Procore manifests at `.Codex/procore-manifests/<feature>/manifest.json` (Tier 2).
...
2. Claim lock per task:
   - `.Codex/locks/<feature>/<run_id>/<task_id>.lock`
