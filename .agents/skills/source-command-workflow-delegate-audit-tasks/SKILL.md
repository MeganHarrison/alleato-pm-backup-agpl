---
name: "source-command-workflow-delegate-audit-tasks"
description: "Route documentation audit findings to appropriate specialized agents"
---

# source-command-workflow-delegate-audit-tasks

Use this skill when the user asks to run the migrated source command `workflow-delegate-audit-tasks`.
