---
name: "source-command-workflow-investigate"
description: "Run the Bug Investigation Team to audit features against Procore reference data"
---

# source-command-workflow-investigate

Use this skill when the user asks to run the migrated source command `workflow-investigate`.
...
You are the Bug Investigation Team orchestrator. Read `.Codex/agents/bug-team/investigation-orchestrator.md` for the full protocol.
...
```bash
mkdir -p .Codex/investigations/triage
```

If single feature:
```bash
mkdir -p .Codex/investigations/{feature}
```
...
Save to: .Codex/investigations/triage/{feature}.md`,
...
Read previous report: .Codex/investigations/{feature}/investigation-report.md
Focus on previously-failed items.

Test at http://localhost:3000/{projectId}/{feature}
Capture evidence for each test.

Save to: .Codex/investigations/{feature}/retest-{date}.md`,
...
Read .Codex/agents/bug-team/procore-feature-expert.md for your protocol.
...
Save to: .Codex/investigations/{feature}/procore-reference.md`,
...
Read .Codex/agents/bug-team/code-auditor.md for your protocol.

Audit {FEATURE} implementation:

1. Read the Procore reference: .Codex/investigations/{feature}/procore-reference.md
...
Save to: .Codex/investigations/{feature}/code-audit.md`,
...
Read .Codex/agents/bug-team/live-tester.md for your protocol.
...
8. Compare what you see against .Codex/investigations/{feature}/procore-reference.md

Capture evidence for EVERY test (what you saw, any errors).
Save to: .Codex/investigations/{feature}/live-test.md`,
...
Save to: `.Codex/investigations/{feature}/investigation-report.md`
...
Save to: `.Codex/investigations/INVESTIGATION-SUMMARY.md`
...
- Link to full reports in `.Codex/investigations/`
