...
Save a few screenshots into `.Codex/artifacts/<run-name>-smoke-shots/` as evidence.
...
Write `.Codex/artifacts/<run-name>-smoke-summary.md`. Create the `.Codex/artifacts/` directory if it doesn't exist. Include:
