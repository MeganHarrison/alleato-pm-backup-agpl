...
The assistant confirms what it saved. Saved facts may be available to other
approved AI tools that serve you—for example, when Eve's financial analysis
skill retrieves a summary, it can apply your preferred format.
