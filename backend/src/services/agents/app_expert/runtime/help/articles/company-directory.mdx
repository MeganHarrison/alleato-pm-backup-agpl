...
description: Manage the global directory of companies, clients, contacts, vendors, distribution groups, and employees.
audience: client
...
4. Tag the company as Client, Vendor, or any combination.
5. Save the record.
